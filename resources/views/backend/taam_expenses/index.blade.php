              ...
              <div class="card-body">
                  <form class="form-horizontal" action="{{ route('business_settings.taam_expenses.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                          <label class="col-lg-3 control-label">{{ translate('Tax') }}</label>
                          <div class="col-lg-9">
                              <div class="input-group">
                                  <input type="number" lang="en" min="0" step="0.01" value="15" placeholder="{{translate('Tax')}}" name="tax" class="form-control" readonly>
                                  <div class="input-group-append">
                      ...
                      <div class="form-group row">
                          <label class="col-lg-3 control-label">{{ translate('Total Taam ') }}</label>
                          <div class="col-lg-9">
                              <div class="input-group">
                                  <input type="number" value="{{$business_settings_renewal->value + $business_settings_renewal->value *0.15}}"  placeholder="{{translate('Tax')}}" name="tax" class="form-control" readonly>
                                  <div class="input-group-append">
                                      <span class="input-group-text">SR</span>
                                  </div>
                              </div>
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.taam_expenses.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="number" value="{{$business_settings_ownership->value + $business_settings_ownership->value *0.15}}"  placeholder="{{translate('Tax')}}" name="tax" class="form-control" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text">SR</span>
                                    </div>
                                </div>
