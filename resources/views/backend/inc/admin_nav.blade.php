<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between" id="nav">
                ...
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                        ...
                        <ul class="list-group c-scrollbar-light overflow-auto" style="max-height:300px;">
                            ...
                            @if($permissions > 0)
                            <li class="list-group-item">
                                <a href="{{ route('permission_exchanges.index') }}" class="text-reset">
                                    <span class="ml-2">{{translate('New Permission Exchange request(s)')}}</span>
                                </a>
                            </li>
                            @endif
                        </ul>
