...
//
    ...
    Route::post('/treasury_balance_update', 'BusinessSettingsController@treasury_balance_update')->name('business_settings.treasury_balance.update');
    ...
    Route::get('/permission_exchanges/destroy/{id}', 'PermissionExchangeController@destroy')->name('permission_exchanges.destroy');
    Route::post('permission_exchanges_approved', 'PermissionExchangeController@update_status')->name('permission_exchanges.approved');
    Route::post('/permission_exchanges/confirm', 'PermissionExchangeController@confirm_exchanges')->name('permission_exchanges.confirm');
    Route::get('permission_exchange/{permission_id}', 'PermissionExchangeController@permission_download')->name('permission.download');
 //report
    Route::get('/users_transactions_report', 'ReportController@users_transactions_report')->name('users_transactions_report.index');
    Route::get('/users_representative_report', 'ReportController@users_representative_report')->name('users_representative_report.index');
